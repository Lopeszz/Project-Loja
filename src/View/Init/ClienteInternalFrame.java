...
public class ClienteInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void initWinButtonInternal() {
        winButtonInternal.initEvent(ClienteInternalFrame.this);
    }
    ...
    private void initComponents() {
        ...
        lblControleFuncionarios.setText("Controle Cliente");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "E-Mail", "Celular", "Cep", "Rua", "Nº", "Comp.", "Bairro", "Cidade", "UF"
            }
        ) {
        ...
        CadastrodeDadosdoFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Img/Cliente/cabecalho/CadastrodeDadosdoCliente.png"))); // NOI18N
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        obj.setId_cliente(Integer.parseInt(txtId.getText()));
        DAOCliente dao = new DAOCliente();
        dao.Update(obj);
        CarregarTabela();
