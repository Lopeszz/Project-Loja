...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/Source/Classes/Campos/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/Source/Classes/Campos/hidden.png")).getImage();
